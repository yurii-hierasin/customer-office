...
import {
    watchRequestAllDocs, watchRequestDeleteDoc,
    watchRequestOrderDocs,
    watchRequestOrderServiceItemDocs,
    watchRequestUploadDoc
} from './docs/sagas';
...
function* rootSaga(api: IApi) {
    yield all([
        ...
        watchRequestDeleteDoc(api),
        watchRequestUploadDoc(api),
